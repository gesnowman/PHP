        ...
        <div class="content-wrapper">
            <div class="content-header row mb-1">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">All My Products</h3>
                </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="float-right">
                                        <a class="btn btn-sm btn-danger box-shadow-2 round btn-min-width pull-right white" href="<?php echo base_url().'index.php/vendor/pending/create';?>">
                                            <i class="ft-plus white"></i>Add New Product
                                        </a>
                                    </div>
                                </div>
                                        ...
                                        <table id="active-accounts" class="table alt-pagination table-wrapper">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-middle">
                                                        <div class="ac-type">
                                                            <img class="img-fluid" style="width:150px" src="<?php echo base_url().'assets/app-assets/images/product/'.$pending->pendingMainImg;?>" >
                                                        </div>
                                                    </td>
                                                    <td class="align-middle">
                                                        <div class="ac-number">
                                                    ...
                                                    <td class="align-middle">
                                                        <div class="ac-hol-name"><?=$pending->subcategoryName;?></div>
                                                    </td>
                                                    <td class="align-middle">
                                                        <div class="ac-hol-name"><?=$pending->pendingCount;?></div>
                                                    </td>
                                                    <td class="align-middle">
                                                        <div class="ac-balance"><?=$pending->pendingPrice;?></div>
                                                    </td>
                                                    <td class="align-middle">
                                                        <?php if($pending->pendingStatus == 'accept'){ ?>
                                                            <div class="ac-status badge badge-success badge-pill badge-sm">Accept</div>
                                                        <?php }else if($pending->pendingStatus == 'reject'){ ?>
                                                            <div class="ac-status badge badge-danger badge-pill badge-sm">Reject</div>
                                                        <?php }else{ ?>
                                                            <div class="ac-status badge badge-warning badge-pill badge-sm">Pending</div>
                                                        <?php } ?>
                                                    </td>
                                                </tr>
                                                    <?php } ?>
