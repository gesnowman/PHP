      ...
      <div class="ps-section--shopping ps-shopping-cart">
        <div class="container">
          ...
          <div class="ps-section__content">
            ...
            <div class="ps-section__cart-actions"><a class="ps-btn" href="<?php echo base_url().'index.php/home/shop'?>"><i class="icon-arrow-left"></i> Back to Shop</a><a class="ps-btn ps-btn--outline" href="shop-default.html"><i class="icon-sync"></i> Submit Inquiry</a></div>
          </div>
        </div>
      </div>
    </div>
