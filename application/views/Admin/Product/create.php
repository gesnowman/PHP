                    ...
                    <div class="card" style="height: 961.5px;">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="<?php echo base_url().'index.php/admin/product/save';?>" enctype='multipart/form-data'>
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="projectinput5" name="vId" required class="form-control" >
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="projectinput1" class="form-control" placeholder="ex: carbon steel..." name="material" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="projectinput1">Product Size/Capacity</label>
                                                            <input type="text" placeholder="ex: 3.6barg, 197kg/h^2 " class="form-control"name="size">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="projectinput1">Product Certification</label>
                                                            <select id="projectinput5" name="certify" class="form-control" required>
