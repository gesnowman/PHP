...
<body ng-app="myFrontend" ng-controller = 'homeController'  ng-init="flag=false"  class="vertical-layout vertical-menu-modern 2-columns   fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
                ...
                <section class="row">
                    ...
                    <div class="card" style="height: 961.5px;">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <div class="card-text">
                                            <p>You can edit category information!</p>
                                        </div>
                                        <form method="post" action="<?php echo base_url().'index.php/admin/subcategory/update';?>">
                                            <input type="hidden" name="fId" value="<?php echo $category_info->subcategoryId;?>">
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-briefcase"></i> SubCategory Info</h4>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">Selected SubCategory</label>
                                                            <input type="text" id="projectinput1" class="form-control" placeholder="SubCategory Name" name="fname" value="<?php echo $category_info->subcategoryName;?>" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="selectId" name="category" required class="form-control">
                                            ...
                                            <div class="form-actions">
                                                <a href="<?php echo base_url().'index.php/admin/subcategory';?>" class="btn btn-warning mr-1">
    ...
    <script>
        $(function() {
             $("#selectId").val("<?php echo $category_info->categoryId;?>");
        });
