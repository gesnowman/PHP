...
<body class="vertical-layout vertical-menu-modern 2-columns   fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
            ...
            <div class="navbar-container content">
                <div class="collapse navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span class="mr-1 user-name text-bold-700">Admin</span><span class="avatar avatar-online"><img src="<?php echo base_url().'assets/app-assets/images/portrait/small/avatar-s-19.png';?>" alt="avatar"><i></i></span></a>
    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="active"><a href="<?php echo base_url().'index.php/admin';?>"><i class="la la-home"></i><span class="menu-title" data-i18n="">eCommerce Dashboard</span></a>
                </li>
                                                    ...
                                                    <td class="text-truncate p-1">
                                                        <ul class="list-unstyled users-list m-0">
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="John Doe" class="avatar avatar-sm pull-up">
                                                                <img class="media-object rounded-circle" src="<?php echo base_url().'assets/app-assets/images/portrait/small/avatar-s-19.png';?>" alt="Avatar">
                                                            </li>
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Katherine Nichols" class="avatar avatar-sm pull-up">
                                                                <img class="media-object rounded-circle" src="<?php echo base_url().'assets/app-assets/images/portrait/small/avatar-s-18.png';?>" alt="Avatar">
                                                            </li>
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Joseph Weaver" class="avatar avatar-sm pull-up">
                                                                <img class="media-object rounded-circle" src="<?php echo base_url().'assets/app-assets/images/portrait/small/avatar-s-17.png';?>" alt="Avatar">
                                                            </li>
                                                    ...
                                                    <td class="text-truncate p-1">
                                                        <ul class="list-unstyled users-list m-0">
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Alice Scott" class="avatar avatar-sm pull-up">
                                                                <img class="media-object rounded-circle" src="<?php echo base_url().'assets/app-assets/images/portrait/small/avatar-s-16.png';?>" alt="Avatar">
                                                            </li>
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Charles Miller" class="avatar avatar-sm pull-up">
                                                                <img class="media-object rounded-circle" src="<?php echo base_url().'assets/app-assets/images/portrait/small/avatar-s-15.png';?>" alt="Avatar">
                                                            </li>
                                                        </ul>
                                                    </td>
                                                    ...
                                                    <td class="text-truncate p-1">
                                                        <ul class="list-unstyled users-list m-0">
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Christine Ramos" class="avatar avatar-sm pull-up">
                                                                <img class="media-object rounded-circle" src="<?php echo base_url().'assets/app-assets/images/portrait/small/avatar-s-11.png';?>" alt="Avatar">
                                                            </li>
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Thomas Brewer" class="avatar avatar-sm pull-up">
                                                                <img class="media-object rounded-circle" src="<?php echo base_url().'assets/app-assets/images/portrait/small/avatar-s-10.png';?>" alt="Avatar">
                                                            </li>
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Alice Chapman" class="avatar avatar-sm pull-up">
                                                                <img class="media-object rounded-circle" src="<?php echo base_url().'assets/app-assets/images/portrait/small/avatar-s-9.png';?>" alt="Avatar">
                                                            </li>
                                                            <li class="avatar avatar-sm">
                                                    ...
                                                    <td class="text-truncate p-1">
                                                        <ul class="list-unstyled users-list m-0">
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Ryan Schneider" class="avatar avatar-sm pull-up">
                                                                <img class="media-object rounded-circle" src="<?php echo base_url().'assets/app-assets/images/portrait/small/avatar-s-14.png';?>" alt="Avatar">
                                                            </li>
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Tiffany Oliver" class="avatar avatar-sm pull-up">
                                                                <img class="media-object rounded-circle" src="<?php echo base_url().'assets/app-assets/images/portrait/small/avatar-s-13.png';?>" alt="Avatar">
                                                            </li>
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Joan Reid" class="avatar avatar-sm pull-up">
                                                                <img class="media-object rounded-circle" src="<?php echo base_url().'assets/app-assets/images/portrait/small/avatar-s-12.png';?>" alt="Avatar">
                                                            </li>
                                                        </ul>
                                                    </td>
                                                    ...
                                                    <td class="text-truncate p-1">
                                                        <ul class="list-unstyled users-list m-0">
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Kimberly Simmons" class="avatar avatar-sm pull-up">
                                                                <img class="media-object rounded-circle" src="<?php echo base_url().'assets/app-assets/images/portrait/small/avatar-s-8.png';?>" alt="Avatar">
                                                            </li>
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Willie Torres" class="avatar avatar-sm pull-up">
                                                                <img class="media-object rounded-circle" src="<?php echo base_url().'assets/app-assets/images/portrait/small/avatar-s-7.png';?>" alt="Avatar">
                                                            </li>
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Rebecca Jones" class="avatar avatar-sm pull-up">
                                                                <img class="media-object rounded-circle" src="<?php echo base_url().'assets/app-assets/images/portrait/small/avatar-s-6.png';?>" alt="Avatar">
                                                            </li>
                                                            <li class="avatar avatar-sm">
                                    ...
                                    <table id="recent-orders" class="table table-hover table-xl mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-truncate">
                                                    <span class="avatar avatar-xs">
                                                        <img class="box-shadow-2" src="<?php echo base_url().'assets/app-assets/images/portrait/small/avatar-s-4.png';?>" alt="avatar">
                                                    </span>
                                                ...
                                                <td class="text-truncate p-1">
                                                    <ul class="list-unstyled users-list m-0">
                                                        <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Kimberly Simmons" class="avatar avatar-sm pull-up">
                                                            <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius" src="<?php echo base_url().'assets/app-assets/images/portfolio/portfolio-1.jpg';?>" alt="Avatar">
                                                        </li>
                                                        <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Willie Torres" class="avatar avatar-sm pull-up">
                                                            <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius" src="<?php echo base_url().'assets/app-assets/images/portfolio/portfolio-2.jpg';?>" alt="Avatar">
                                                        </li>
                                                        <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Rebecca Jones" class="avatar avatar-sm pull-up">
                                                            <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius" src="<?php echo base_url().'assets/app-assets/images/portfolio/portfolio-4.jpg';?>" alt="Avatar">
                                                        </li>
                                                        <li class="avatar avatar-sm">
                                                            <span class="badge badge-info">+1 more</span>
                                                        </li>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-truncate">
                                                    <span class="avatar avatar-xs">
                                                        <img class="box-shadow-2" src="<?php echo base_url().'assets/app-assets/images/portrait/small/avatar-s-5.png';?>" alt="avatar">
                                                    </span>
                                                    <span>Doris R.</span>
                                                </td>
                                                <td class="text-truncate p-1">
                                                    <ul class="list-unstyled users-list m-0">
                                                        <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Kimberly Simmons" class="avatar avatar-sm pull-up">
                                                            <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius" src="<?php echo base_url().'assets/app-assets/images/portfolio/portfolio-5.jpg';?>" alt="Avatar">
                                                        </li>
                                                        <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Willie Torres" class="avatar avatar-sm pull-up">
                                                            <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius" src="<?php echo base_url().'assets/app-assets/images/portfolio/portfolio-6.jpg';?>" alt="Avatar">
                                                        </li>
                                                        <li class="avatar avatar-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-truncate">
                                                    <span class="avatar avatar-xs">
                                                        <img class="box-shadow-2" src="<?php echo base_url().'assets/app-assets/images/portrait/small/avatar-s-6.png';?>" alt="avatar">
                                                    </span>
                                                    <span>Megan S.</span>
                                                </td>
                                                <td class="text-truncate p-1">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-truncate">
                                                    <span class="avatar avatar-xs">
                                                        <img class="box-shadow-2" src="<?php echo base_url().'assets/app-assets/images/portrait/small/avatar-s-7.png';?>" alt="avatar">
                                                    </span>
                                                    <span>Andrew D.</span>
                                                </td>
                                                <td class="text-truncate p-1">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-truncate">
                                                    <span class="avatar avatar-xs">
                                                        <img class="box-shadow-2" src="<?php echo base_url().'assets/app-assets/images/portrait/small/avatar-s-9.png';?>" alt="avatar">
                                                    </span>
                                                    <span>Walter R.</span>
                                                </td>
                                                <td class="text-truncate p-1">
                                                    <ul class="list-unstyled users-list m-0">
                                                        ...
                                                        <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Willie Torres" class="avatar avatar-sm pull-up">
                                                            <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius" src="<?php echo base_url().'assets/app-assets/images/portfolio/portfolio-3.jpg';?>" alt="Avatar">
                                                        </li>
                                                    </ul>
                                                </td>
                                                <td>
                ...
                <div class="row match-height">
                    <div class="col-xl-4 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <img class="img-fluid" src="<?php echo base_url().'assets/app-assets/images/carousel/05.jpg';?>" alt="Card image cap">
                                <div class="card-body">
    ...
    <script src="<?php echo base_url().'assets/app-assets/vendors/js/timeline/horizontal-timeline.js';?>"></script>
    <!-- END: Page Vendor JS-->
