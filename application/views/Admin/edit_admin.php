                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="<?php echo base_url().'index.php/admin/update';?>">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="projectinput1" class="form-control" placeholder="First Name" name="fname" value="admin" disabled required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="form-actions">
                                                <a href="<?php echo base_url().'index.php/admin';?>" class="btn btn-warning mr-1">
