                            ...
                            <div class="card-head">
                                <div class="card-header">
                                    ...
                                    <div class="heading-elements">
                                        <a class="btn btn-primary btn-sm" href="<?php echo base_url().'index.php/admin/category/create';?>"><i class="ft-plus white"></i> Create Category</a>
                                ...
                                <div class="card-body">
                                    ...
                                    <div ng-if="flag"class="alert alert-danger mb-2" role="alert">
                                        ...
                                        <table id="active-accounts" class="table alt-pagination table-wrapper">
                                            <thead>
                                                <tr>
                                                    <th class="border-top-0">CategoryNo</th>
                                                    <th class="border-top-0">CategoryName</th>
                                                    <th class="border-top-0">Actions</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php $index = 0; foreach($category_list as $category){ $index ++; ?>
                                                 <tr>
                                                    <td class="align-middle">
                                                        <div class="ac-type"><?=$index;?></div>
                                                    </td>
                                                    <td class="align-middle">
                                                        <div class="ac-number"><?=$category->categoryName;?></div>
                                                    </td>
                                                    <td class="align-middle">
                                                        <div class="action">
