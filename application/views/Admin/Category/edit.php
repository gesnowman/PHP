            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item has-sub open"><a href="#"><i class="la la-clipboard"></i><span class="menu-title" data-i18n="nav.invoice.main">Category</span></a>
                    <ul class="menu-content">
                        <li class="active"><a class="menu-item" href="<?php echo base_url().'index.php/admin/category';?>"><i></i><span data-i18n="nav.invoice.invoice_summary">Categories</span></a>
                        </li>
                ...
                <section class="row">
                    ...
                    <div class="card" style="height: 961.5px;">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <div class="card-text">
                                            <p>You can add category topic!</p>
                                        </div>
                                        <form method="post" action="<?php echo base_url().'index.php/admin/category/update';?>">
                                             <input type="hidden"  name="fId"  value="<?php echo $categories_info->categoryId;?>">
                                             <div class="form-body">
                                                <h4 class="form-section"><i class="ft-user"></i>Category Info</h4>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">New Topic</label>
                                                            <input type="text" id="projectinput1" class="form-control" placeholder="input content...." name="fname" value="<?php echo $categories_info->categoryName;?>" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-actions">
                                                <a href="<?php echo base_url().'index.php/admin/category';?>" class="btn btn-warning mr-1">
