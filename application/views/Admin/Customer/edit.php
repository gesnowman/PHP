...
<body ng-app="myFrontend" ng-controller = 'homeController'  ng-init="flag=false"  class="vertical-layout vertical-menu-modern 2-columns   fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
                    ...
                    <div class="card" style="height: 961.5px;">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="<?php echo base_url().'index.php/admin/customer/update';?>">
                                           <input type="hidden" id="projectinput1" class="form-control" placeholder="First Name" name="fId"  value="<?php echo $user_info->customerId;?>"required>
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="projectinput1" class="form-control" placeholder="First Name" name="fname"  value="<?php echo $user_info->customerName;?>"required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="projectinput3" class="form-control" placeholder="E-mail" name="email"  value="<?php echo $user_info->customerEmail;?>" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="projectinput6" class="form-control" placeholder="Position" name="position" value="<?php echo $user_info->customerPosition;?>" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="projectinput6">Company</label>
                                                            <input type="text" id="projectinput6" class="form-control" placeholder="Company Name" name="company" value="<?php echo $user_info->customerCompany;?>" required>
                                                        </div>
                                                    </div>
    ...
    <script>
            $(function() {
            $("#selectId").val('<?=$user_info->customerGender;?>');
