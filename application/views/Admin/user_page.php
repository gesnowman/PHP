...
<body ng-app="myFrontend" ng-controller = 'homeController'  ng-init="flag=false"  class="vertical-layout vertical-menu-modern 2-columns   fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="active nav-item"><a href="<?php echo base_url().'index.php/admin/user';?>"><i class="la la-th-large"></i><span class="menu-title" data-i18n="">User</span></a>
                </li>
                            ...
                            <div class="card-head">
                                <div class="card-header">
                                    ...
                                    <div class="heading-elements">
                                        <a class="btn btn-primary btn-sm" href="<?php echo base_url().'index.php/admin/user/create';?>"><i class="ft-plus white"></i> Create User</a>
                                        ...
                                        <table id="active-accounts" class="table alt-pagination table-wrapper">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-middle"><div class="ac-type"><?=$user->userEmail;?></div></td>
                                                    <td class="align-middle"><div class="ac-type"><?=$user->userPhonenumber;?></div></td>
                                                    <td class="align-middle"><div class="ac-type"><?=$user->userBirthday;?></div></td>
                                                    <td class="align-middle">
                                                       <div class="action">
                                                            <a ng-click="editBtn('<?=$user->userId?>')"><i class="la la-pencil-square success"></i></a>
                                                            <a ng-click="deleteBtn('<?=$user->userId?>')"><i class="la la-trash danger"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <?php } ?>
    ...
    App.controller('homeController', function($scope, $http){
        $scope.editBtn = function(data){
            ...
            // }else{
                $scope.flag = false;
                location.assign(base_url + 'index.php/admin/user/edit/' + data);
            // }
        }
        ...
        //    if(!dArr[0]){
        //     $scope.flag = true;
        //     $scope.ngAlert = "you must check to delete user info";   
        //    }else{
               $scope.flag = false;
               temp_data= {
                   arr : data
               }
               $http.post(base_url + 'index.php/admin/user/del',JSON.stringify(temp_data)).then(function (response){
                    // alert(JSON.stringify(response.data));
                    location.assign(base_url + 'index.php/admin/user');
                });
        }
        // $scope.flag = false; 
        ...
        //             userGender: uCheck,
        //             userBirthday: uPass,
        //             userPhonenumber: uPass,
        //         };
        //         $http.post(base_url + 'index.php/admin/add',JSON.stringify(data)).then(function (response){
        //             // $scope.pc_state_arr = response.data;
        //             // alert(JSON.stringify(response.data));
        //             if(response.data == 'true')
        //                 location.assign(base_url + 'index.php/admin');
        //             else{
        //                 $scope.flag = true; 
