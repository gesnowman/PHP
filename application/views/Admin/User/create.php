                    ...
                    <div class="card" style="height: 961.5px;">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="<?php echo base_url().'index.php/admin/user/do_upload';?>" enctype="multipart/form-data">
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" id="projectinput6" class="form-control" placeholder="Company Name" name="birthday"  required>
                                                        </div>
                                                    </div>
