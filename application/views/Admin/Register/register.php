                                        ...
                                        <table id="active-accounts" class="table alt-pagination table-wrapper">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-middle"><?=$register->registerDate;?></td>
                                                    <td class="align-middle">
                                                        <div class="product-img d-flex align-items-center">
                                                            <img class="img-fluid " style="width:100px;align:center"src="<?php echo base_url().'assets/app-assets/images/product/'.$register->productMainImg;?>" >
                                                        </div>
                                                    </td>
                                                    <td class="align-middle"><?=$register->productName?></td>
                                                    <td class="align-middle"><?=$register->registerPrice;?>$</td>
                                                    <td class="align-middle"><?=$register->registerCount;?></td>
